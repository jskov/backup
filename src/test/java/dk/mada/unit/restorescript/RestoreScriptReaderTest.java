...
class RestoreScriptReaderTest {
    ...
    void canReadV2Data() {
        ...
        assertThat(data.cryptsV2())
            .containsExactly(
                    new DataCryptV2(124221499L, Xxh3.ofHex("1eb326ca04a97a48"), Md5.ofHex("de275e40fe159cce2b5f198cad71b0d9"), "A-D.crypt"),
                    new DataCryptV2( 69264274L, Xxh3.ofHex("663b0cb7a10aaa62"), Md5.ofHex("9d9576cec753d39605e22e9937816448") ,"E-H.crypt"),
                    new DataCryptV2(      140L, Xxh3.ofHex("223b0cb7a10aaa62"), Md5.ofHex("4d9576cec753d39605e22e9937816448") ,"info.txt.crypt")
                    );
        ...
        .contains(
                ...
                new DataFileV2(2155175L, Xxh3.ofHex("3a23e1befbac7319"), "A-D/Anderson, Kevin J./2113 - Stories Inspired by the Music of Rush - edited by Kevin J. Anderson and John McFetridge.epub"),
